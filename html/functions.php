<?php
    ...
    /******************************
     * Toevoegen custom VC codes. *
     *****************************/
    add_action('vc_before_init', 'vc_before_init_actions');
    function vc_before_init_actions()
    {
        require_once(get_template_directory().'/inc/vc-elements/vc-elements.php');
    }
        ...
        foreach ($rev_files as $key => $item) {
            if ($_SERVER['HTTP_HOST'] == "bettersales.sem" /* OR $_SERVER['HTTP_HOST'] == "bettersales.magneet.it" */) {
                ...
                add_filter('body_class', function ($classes) {
                    return array_merge($classes, array( 'dev' ));
                });
                ...
                // Add css class to body.
                add_filter('body_class', function ($classes) {
                    return array_merge($classes, array( 'dist' ));
                });
                // Add JS and CSS files
